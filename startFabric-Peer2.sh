...
Usage() {
	...
	echo ""
	echo "Example: ./startFabric-peer.sh"
	echo ""
	exit 1
}
...
# docker-compose -f "${DIR}"/composer/docker-compose-peer2.yml down
docker-compose -f "${DIR}"/composer/docker-compose-peer2.yml up -d
